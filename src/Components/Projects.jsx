...
function Projects(){
   ...
   useEffect(() => {
    // This code will run only once after the initial render (component mount),Empty Array make this runs only once'
            ...
            const q =  query(collection(db, '/CV/Malaka/Projects'));
...
return(
  ...
  <Grid gap="0" width="100wh" height="100vh" rows="1" columns="1" >
    ...
    <Flex gap="1" className="navpanel" height="10vh" width="100wh"  direction="row" align="center" justify="center" wrap="wrap" overflow="auto"> 
        ...
        <Flex width="5%" minWidth="100px" height="100%" justify="center" align="center" className="nav" onClick={NavigIntrests}>
              <Text style={{ color:'white' }} size="3">Intrests</Text>
        </Flex>

      </Flex>
      <Flex gap="3" className="main" height="90vh" width="100wh" direction="column" justify="center" align="center" wrap="wrap" overflow="auto">
